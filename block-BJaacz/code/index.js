...
let addTwoToArray = function(cb, arr) {
  let newArray = [];
  for(numbers of arr) {
      newArray.push(cb(numbers));
  }
  return newArray;
}
console.log(addTwoToArray(addTwo, [1,0,8,79]));
...
*/
let addThreeToArray = function(cb, arr) {
  let newArray = [];
  for(numbers of arr) {
      newArray.push(cb(numbers));
  }
...
console.log(addThreeToArray(addThree, arr));
...
/*
  Create a function named addFiveToArray which accepts:
    ...
    - while doing so use the funciton addThree
*/
let addFiveToArray = function(cb, arr) {
  let newArray = [];
  for(numbers of arr) {
      newArray.push(cb(numbers));
  }
...
console.log(addFiveToArray(addFive, arr));
...
*/
let isAdult = function(ex_object){
  if(ex_object.age > 18){
    return true;
  } else {
    return false;
...
*/
let isFemale = function(ex_object){
  if(ex_object.sex === "F"){
    return true;
  } else {
    return false;
...
*/
let isGradeA = function(ex_object){
  if(ex_object.grade > 12){
    return true;
  } else {
    return false;
  }
...
*/
let isGradeB = function(ex_object){
  if(ex_object.grade >= 8 && ex_object.grade <= 12){
    return true;
  } else {
    return false;
  }
...
let isGradeC = function(ex_object){
  if(ex_object.grade <= 8){
    return true;
  } else {
    return false;
  }
...
let filterGradeA = (arr) => {
  let finalGrade = [];
  for(let gradee of arr){
    if(isGradeA(gradee)){
      finalGrade.push(gradee);
    }
  }
  return finalGrade;
}
console.log(filterGradeA(grades), "gradeA");
...
console.log(filterGradeB(grades), "gradeB");
/*
...
console.log(filterGradeC(grades), "gradeC");
...
let filter = (arr, cb) => {
  let finalArr = [];
  for(let finalFilter of arr){
    if(cb(finalFilter)){
      finalArr.push(finalFilter);
    }
  }
  return finalArr;
}
